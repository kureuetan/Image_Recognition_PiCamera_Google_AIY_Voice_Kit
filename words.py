...
words_dict = {
    ...
    'talk_start_hotword':
    'Say your hotword and comands. "What is this?", "Can you read this?" or "What logo is this?"',
    'command_list':
    ...
    'talk_start_hotword':
    'Di tu palabra clave y tus comandos. "¿Qué es esto?", "¿Puedes leer esto?" o "¿Qué logo es este?" ',
    'command_list':
    ...
    'talk_start_hotword':
    'ホットワードで呼びかけ、「これは何ですか」「これは何と読みますか」\n「このロゴは何ですか」などのコマンドを言ってください',
    'command_list':
    '有効なコマンド一覧',
    'waiting_button':
    'ボタンが押されるのを待っています...',
